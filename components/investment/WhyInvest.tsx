...
export default function WhyInvest() {
  return (
    <section id="why-invest" className="relative bg-[#0A0A0C] dark:bg-[#F5F5F0] py-20 md:py-28">
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <p className="mt-6 text-lg leading-relaxed text-[#9A9AA0] dark:text-[#6B6B70]">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {whyInvestItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="mb-6">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-full border border-[#2A2A2F] dark:border-[#E5E5E0] flex items-center justify-center text-[#8EC5FF] dark:text-[#5B9FE5] group-hover:border-[#8EC5FF]/40 dark:border-[#5B9FE5]/40 transition-colors">
                    <IconComponent className="w-6 h-6" />
                  </div>
                </div>

                <h3 className="text-sm font-bold leading-snug tracking-[-0.02em] text-[#EDEDE8] dark:text-[#1A1A1E] mb-3">
                  {item.title}
                </h3>
